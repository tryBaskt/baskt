...
ENV_KEYS_FOR_LAMBDA = (
    ...
    "TEST_COGNITO_APP_CLIENT_ID",
    "STAGE_COGNITO_REGION",
    "STAGE_COGNITO_USER_POOL_ID",
    "STAGE_COGNITO_APP_CLIENT_ID",
    "PROD_COGNITO_REGION",
    "PROD_COGNITO_USER_POOL_ID",
    "PROD_COGNITO_APP_CLIENT_ID",
    ...
    "TEST_TRADE_EXECUTION_QUEUE_URL",
    "STAGE_TRADE_EXECUTION_QUEUE_URL",
    "PROD_TRADE_EXECUTION_QUEUE_URL",
)
...
def _lambda_environment_variables(queue_url: str) -> Dict[str, str]:
    ...
    variables[f"{variables['ENV'].upper()}_TRADE_EXECUTION_QUEUE_URL"] = queue_url
    return variables
