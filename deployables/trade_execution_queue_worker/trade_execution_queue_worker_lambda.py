...
Trade worker deployment is owned by Terraform and GitHub Actions. This file
remains only to fail closed for old manual commands.
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Manual deployment is disabled. Deploy this worker through "
