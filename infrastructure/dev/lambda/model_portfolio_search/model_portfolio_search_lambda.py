...
def _ensure_role(iam: Any, domain_arn: str) -> str:
    ...
    try:
        ...
        role = iam.create_role(
            ...
            Description="Indexes model portfolio DynamoDB changes in OpenSearch.",
        )["Role"]
...
def _domain_configuration(opensearch: Any, domain_name: str) -> Dict[str, str]:
...
def _latest_stream_arn(dynamodb: Any) -> str:
    """Return the enabled stream ARN for the model portfolio table."""
        ...
        for attempt in range(6):
            try:
                lambda_client.create_function(
                    ...
                    Description="Indexes model portfolio changes in OpenSearch.",
                    Timeout=30,
                    MemorySize=256,
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Manage the dev model portfolio search-index Lambda."
    )
