#!/usr/bin/env python3
"""
Script to create or destroy the dev_model_portfolio_update_lock_dynamodb table.

Usage:
	python model_portfolio_update_lock_dynamodb.py --create   # Create the table
	python model_portfolio_update_lock_dynamodb.py --destroy  # Delete the table
"""
...
def create_dev_model_portfolio_update_lock_dynamodb():
...
def delete_dev_model_portfolio_update_lock_dynamodb():
	"""Delete the dev_model_portfolio_update_lock_dynamodb table."""
	TABLE_NAME = configurations["table_name"]
	REGION = configurations["region"]
...
def main():
	...
	if args.create:
		create_dev_model_portfolio_update_lock_dynamodb()
	elif args.destroy:
		delete_dev_model_portfolio_update_lock_dynamodb()
