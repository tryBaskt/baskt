#!/usr/bin/env python3
"""
Script to create or destroy the dev_order_dynamodb table.

Usage:
    python order_dynamodb.py --create   # Create the table
    python order_dynamodb.py --destroy  # Delete the table
"""
...
def create_dev_order_dynamodb():
    ...
    table_config = {
        ...
        'AttributeDefinitions': [
            ...
            {
                'AttributeName': gsi_configs[0]["gsi_partition_key"],
                'AttributeType': 'S'
            },
            {
                'AttributeName': gsi_configs[0]["gsi_sort_key"],
                'AttributeType': 'S'
            }
        ],
        'KeySchema': [
...
def delete_dev_order_dynamodb():
    """
    Delete the dev_order_dynamodb table.
    """
    TABLE_NAME = configurations["table_name"]
    REGION = configurations["region"]
...
def main():
    ...
    if args.create:
        create_dev_order_dynamodb()
    elif args.destroy:
        delete_dev_order_dynamodb()
