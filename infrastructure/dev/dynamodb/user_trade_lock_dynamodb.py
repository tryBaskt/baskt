#!/usr/bin/env python3
"""
Script to create or destroy the dev_user_trade_lock_dynamodb table.

Usage:
	python user_trade_lock_dynamodb.py --create   # Create the table
	python user_trade_lock_dynamodb.py --destroy  # Delete the table
"""
...
def create_dev_user_trade_lock_table():
...
def delete_dev_user_trade_lock_table():
	TABLE_NAME = configurations["table_name"]
	REGION = configurations["region"]
...
def main():
	...
	if args.create:
		create_dev_user_trade_lock_table()
	elif args.destroy:
		delete_dev_user_trade_lock_table()
