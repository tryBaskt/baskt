#!/usr/bin/env python3
"""
Script to create or destroy the dev_portfolio_allocation_dynamodb table.

Usage:
    python portfolio_allocation_dynamodb.py --create   # Create the table
    python portfolio_allocation_dynamodb.py --destroy  # Delete the table
"""
...
def create_dev_portfolio_allocation_table():
    # Hardcoded configuration from dev-user-portfolio-allocation table
...
def delete_dev_portfolio_allocation_table():
    """
    Delete the dev_portfolio_allocation_dynamodb table.
    """
    TABLE_NAME = configurations["table_name"]
    REGION = configurations["region"]
...
def main():
    ...
    if args.create:
        create_dev_portfolio_allocation_table()
    elif args.destroy:
        delete_dev_portfolio_allocation_table()
