resource "aws_scheduler_schedule" "market_close" {
  name                         = "${var.environment}-trade-execution-close"
  schedule_expression          = "cron(58 15 ? * MON-FRI *)"
